...
public class CrearMonitorActivity extends AppCompatActivity {
    ...
    private final ActivityResultLauncher<Intent> launcherGaleria =
            registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), result -> {
                if (result.getResultCode() == RESULT_OK && result.getData() != null) {
                    ...
                    binding.ivFotoMonitor.setImageURI(imagenUriSeleccionada);
                }
            });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnCrearMonitor.setOnClickListener(v -> crearMonitor());
    }
    ...
    private void crearMonitor() {
        ...
        Monitor monitor = new Monitor(
                idMonitor, nombre, apellidos, dni, fechaNacimiento, telefono, correo, fotoUrl, idAdministrador
        );
        ...
        db.collection("monitores").document(idMonitor).set(monitor)
                ...
                .addOnFailureListener(e -> Toast.makeText(this, "Error al guardar monitor", Toast.LENGTH_SHORT).show());
    }
