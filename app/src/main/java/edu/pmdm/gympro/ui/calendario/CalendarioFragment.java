...
public class CalendarioFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        tvDescripcion = view.findViewById(R.id.tvDescription); // asegúrate que existe en el XML
    ...
    private void cargarHorarios() {
        ...
        db.collection("grupos").get().addOnSuccessListener(queryDocumentSnapshots -> {
            ...
            for (QueryDocumentSnapshot doc : queryDocumentSnapshots) {
                ...
                if (horarios != null) {
                    for (Map<String, Object> horario : horarios) {
                        String diaTexto = horario.get("dia").toString(); // "Martes"
                        ...
                        if (index != -1) {
                            ...
                            if (!clasesPorDiaSemana.containsKey(index)) {
                                clasesPorDiaSemana.put(index, new ArrayList<>());
                            }
                            clasesPorDiaSemana.get(index).add(textoClase);
                        }
                    }
                }
            }
